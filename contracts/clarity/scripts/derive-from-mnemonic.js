 ...
 * 
 * Usage:
 *   cd contracts/clarity/scripts
 *   node derive-from-mnemonic.js "your twelve word mnemonic phrase here"
 */
...
async function derivePrivateKey(mnemonic) {
  if (!mnemonic) {
    ...
    console.error('');
    console.error('Usage:');
    console.error('  node derive-from-mnemonic.js "your twelve word mnemonic phrase"');
    console.error('');
    console.error('Or set as environment variable:');
    console.error('  MNEMONIC="your mnemonic" node derive-from-mnemonic.js');
    process.exit(1);
  }
